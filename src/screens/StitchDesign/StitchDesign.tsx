...
export const StitchDesign = (): JSX.Element => {
  ...
  return (
    <div className={`flex flex-col items-start relative min-h-screen transition-colors duration-300 ${themeClasses}`}>
      <div className="flex flex-col min-h-[800px] items-start relative self-stretch w-full flex-[0_0_auto]">
        <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex items-start justify-center gap-1 px-6 py-5 relative flex-1 self-stretch w-full grow">
            {/* Sidebar */}
            <aside className={`w-80 relative h-[760px] transition-colors duration-300 ${sidebarThemeClasses}`}>
              {/* Profile section */}
              <div className="flex w-80 h-[228px] items-start p-4 absolute top-0 left-0">
                <div className="flex flex-col items-start gap-4 relative flex-1 grow">
                  <div className="inline-flex flex-col items-start gap-4 relative flex-1 grow">
                    ...
                    <div className="inline-flex flex-col items-start justify-center relative flex-[0_0_auto]">
                      ...
                      <div className="flex flex-col w-[271px] items-start relative flex-[0_0_auto]">
              ...
              {/* Footer */}
              <div className={`absolute w-[285px] h-6 top-[735px] left-[9px] font-normal text-base text-center tracking-[0] leading-6 transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-[#5b8984]'}`}>
                © powered by JRBC - 2025 All Rights Reserved
              </div>
            </aside>

            {/* Main content */}
            <main className="flex flex-col max-w-[960px] items-start flex-1 grow relative h-[760px]">
              ...
              <div className="flex flex-col items-start pt-0 pb-3 px-0 relative self-stretch w-full flex-[0_0_auto]">
                <div className={`relative self-stretch w-full h-[54px] border-b transition-colors duration-300 ${isDarkMode ? 'border-gray-700' : 'border-[#d6e2e0]'}`}>
                  <Tabs className="w-full flex-1" defaultValue="extraction">
