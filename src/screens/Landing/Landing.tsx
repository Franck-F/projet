        ...
        <section className="w-4/5 h-full px-4 sm:px-6 py-10 sm:py-12 flex items-center mx-auto xl:h-full xl:w-4/5">
          <div className="w-full h-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center xl:w-full xl:h-full">
            <div className="lg:col-span-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-base sm:text-lg lg:text-2xl">
                <Sparkles className="h-4 w-4" />
                Plate‑forme IA pour les documents
              </div>
              <h1 className="mt-4 text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-8xl font-bold tracking-tight">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild className="lg:h-16 lg:w-64  px-6 bg-blue-600 hover:bg-blue-500 text-white text-base lg:text-lg xl:text-xl">
                  <Link to="/app" className="inline-flex items-center gap-2">Commencer <ArrowRight className="h-8 w-8" /></Link>
                </Button>
                <Button asChild variant="outline" className="lg:h-16 lg:w-56 px-6 border-gray-700 bg-gray-900 hover:bg-gray-800 text-gray-200 text-base lg:text-lg xl:text-xl">
            ...
            <div className="lg:col-span-6 hidden md:flex">
              ...
              <div className="lg:w-full lg:h-auto rounded-2xl border border-gray-800 bg-gray-900/60 shadow-xl p-5 backdrop-blur">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-3 transition-transform duration-300 hover:-translate-y-1">
                    <div className="inline-flex items-center gap-2 text-emerald-300 mb-2 text-base lg:text-lg xl:text-xl">
                      <FileText className="h-15 w-15 lg:h-12 lg:w-12 xl:h-17 xl:w-17" />
                      Rapport automatisé
                    </div>
