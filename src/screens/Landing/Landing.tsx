...
export const Landing = (): JSX.Element => {
  ...
  return (
    <>
        ...
        <header className="relative z-10 border-b border-gray-800/70">
          <div className="w-4/5 mx-auto px-4 sm:px-6 py-10 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 text-gray-300">
              ...
              <Button onClick={() => openLoginPopup("/app")} className="bg-blue-600 hover:bg-blue-500 text-white inline-flex items-center gap-2 lg:text-xl">
                Commencer
      ...
      {isLoginPopupOpen && <LoginPopup onClose={closeLoginPopup} targetUrl={targetUrl} />}
    </>
  );
};
